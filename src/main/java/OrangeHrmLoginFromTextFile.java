...
public class OrangeHrmLoginFromTextFile {
	...
	File testData = new File("src/main/resources/UID.txt");
	...
	public Object[][] getDataFromTxtFile() throws FileNotFoundException {
		...
		Scanner fileIn = new Scanner(testData);
		...
		fileIn.reset();
		Scanner fileIn1 = new Scanner(testData);
	...
	public void userLoginTest(String username, String password) throws InterruptedException, IOException {
		...
		//By adminDropDown = By.xpath("//*[@id='welcome']"); 
				...
				//By.id("welcome-menu");
		String actualTitle = "", expectedTitle = "OrangeHRM", expectedAdminMenuTxt = "Administraci�n", actualAdminMenuTxt = "";

        System.setProperty("webdriver.chrome.driver", Paths.get("src/main/resources/drivers/chromedriver").toString());
	...
	public static void main(String[] args) {
		...
		//This runner is essentially acting as our testNG xml. Everything here correlates to what you would find in the xml.
		XmlSuite suite = new XmlSuite();
		suite.setName("Test Suite");

		List<XmlClass> classes = new ArrayList<XmlClass>();
		classes.add(new XmlClass("OrangeHrmLoginFromTextFile"));
